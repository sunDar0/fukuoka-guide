    ...
    if (typeof window.itineraryTemplates === 'undefined') {
        ...
        window.itineraryTemplates[3] = {
            ...
            days: [
                ...
                {
                    day: 2, title: '시사이드 실내 가족 코스',
                    summary: '실내 대형 수족관 마린월드로 유아 핵심, 오후 오호리·미술관, 저녁 후쿠오카 타워 크리스마스 트리',
                    timeline: [
                        ...
                        { time: '12:00', icon: '🍱', activity: '점심 & 차량 이동', details: '마린월드 인근 또는 복귀 길 식당. 마린월드→오호리 차로 약 30분 남하', childNote: '이동 시간이 유아 낮잠 슬롯과 겹쳐 차에서 휴식' },
                        { time: '13:30', icon: '🎨', activity: '후쿠오카시 미술관', details: '오호리 공원 내, 공원 주차장 이용. 실내 전시(달리·미로)', childNote: '실내라 따뜻. 유아차 가능, 노부모 천천히 관람' },
                        { time: '14:45', icon: '🌳', activity: '오호리 공원 (짧게)', details: '미술관에서 도보 인접. 겨울이라 둘레길 완주 대신 일본정원·호반 짧은 산책 30분', childNote: '추우면 생략 가능. 유아 잠깐 바람 쐬기' },
                        { time: '16:00', icon: '🗼', activity: '후쿠오카 타워 (야간 크리스마스 트리)', details: '오호리에서 차로 약 10분, 타워 주차장. 실내 전망대 + 12월 108m 외벽 크리스마스 트리 점등(일몰 후)', childNote: '전망대 실내라 따뜻. 야경·트리 유아도 좋아함, 노부모 엘리베이터' },
