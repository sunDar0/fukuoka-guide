    ...
    if (typeof window.itineraryTemplates === 'undefined') {
        ...
        window.itineraryTemplates[3] = {
            ...
            days: [
                {
                    day: 1, title: '하카타 도착 & 시내 탐방',
                    summary: '후쿠오카 공항 도착 후 하카타역 주변 탐색과 야타이 체험',
                    timeline: [
                        { time: '11:00', icon: '✈️', activity: '후쿠오카 공항 도착', details: '입국 수속 후 지하철로 하카타역 이동 (5분, 260엔)', childNote: '공항 내 유아 휴게실 이용 가능' },
                        { time: '12:00', icon: '🏨', activity: '호텔 체크인', details: '하카타역 주변 호텔 체크인 및 짐 정리', childNote: '' },
                        { time: '13:00', icon: '🍜', activity: '하카타 라멘 점심', details: '이치란 본점 또는 신신라멘에서 돈코츠 라멘', childNote: '어린이용 메뉴 있음' },
                        { time: '14:30', icon: '🛍️', activity: '캐널시티 하카타', details: '대형 쇼핑몰 구경, 분수 쇼(매시간), 면세 쇼핑', childNote: '키즈 놀이 공간 및 수유실 있음' },
                        { time: '16:30', icon: '⛩️', activity: '쿠시다 신사', details: '하카타 총 수호 신사 방문. 기온 야마카사 장식 수레 관람', childNote: '' },
                        { time: '17:30', icon: '🏨', activity: '휴식', details: '호텔에서 잠시 쉬기', childNote: '' },
                        { time: '19:00', icon: '🏮', activity: '나카스 야타이', details: '나카스강변 포장마차 거리에서 교자, 야키토리, 라멘 즐기기', childNote: '야타이는 좌석이 좁으니 유아 동반 시 주의' }
                    ]
                },
                {
                    day: 2, title: '다자이후 당일치기',
                    summary: '일본 학문의 신을 모신 다자이후 텐만구와 주변 관광',
                    timeline: [
                        { time: '08:30', icon: '🍳', activity: '아침 식사', details: '호텔 조식 또는 하카타역 주변 카페', childNote: '' },
                        { time: '09:30', icon: '🚃', activity: '다자이후로 이동', details: '니시테츠 텐진역 → 니시테츠 후츠카이치 → 다자이후역 (약 40분, 410엔)', childNote: '니시테츠 열차 내 좌석 넓은 편' },
                        { time: '10:30', icon: '⛩️', activity: '다자이후 텐만구', details: '학문의 신 스가와라노 미치자네를 모신 신사. 본전까지 참배길 산책', childNote: '' },
                        { time: '11:30', icon: '🍵', activity: '우메가에모치 맛보기', details: '참배길에서 명물 매화떡 시식. 카사노야 본점 추천', childNote: '' },
                        { time: '12:00', icon: '🏛️', activity: '규슈국립박물관', details: '다자이후 텐만구 뒤편의 대형 박물관. 아시아 문화 전시', childNote: '어린이 체험관(아지파) 무료 이용 가능' },
                        { time: '13:30', icon: '🍱', activity: '다자이후 점심', details: '참배길의 식당에서 규슈 향토 요리 또는 소바', childNote: '' },
                        { time: '14:30', icon: '🌿', activity: '고묘젠지 (광명선사)', details: '아름다운 이끼 정원으로 유명한 사찰. 조용한 힐링 명소', childNote: '' },
                        { time: '16:00', icon: '🚃', activity: '후쿠오카 복귀', details: '다자이후역에서 니시테츠 열차로 텐진 이동', childNote: '' },
                        { time: '17:00', icon: '🛍️', activity: '텐진 쇼핑', details: '텐진 지하상가, 다이마루 백화점 쇼핑', childNote: '' },
                        { time: '19:00', icon: '🍲', activity: '모츠나베 저녁', details: '텐진 인근 모츠나베 전문점에서 후쿠오카 향토 요리', childNote: '모츠나베는 아이도 먹을 수 있는 순한 맛 선택 가능' }
                    ]
                },
                {
                    day: 3, title: '오호리 공원 & 해변 산책',
                    summary: '오호리 공원과 모모치 해변에서 여유로운 하루',
                    timeline: [
                        { time: '09:00', icon: '🍳', activity: '조식', details: '호텔 조식 후 체크아웃 준비', childNote: '' },
                        { time: '10:00', icon: '🌳', activity: '오호리 공원', details: '호수 둘레길 산책(약 2km), 일본 정원 관람', childNote: '놀이터와 보트 체험 가능' },
                        { time: '11:30', icon: '🏯', activity: '후쿠오카성터', details: '마이즈루 공원 내 성터에서 시내 전경 감상', childNote: '' },
                        { time: '12:30', icon: '🍱', activity: '점심', details: '오호리 공원 주변 카페 또는 레스토랑', childNote: '' },
                        { time: '14:00', icon: '🏖️', activity: '모모치 해변 & 후쿠오카 타워', details: '해변 산책 후 후쿠오카 타워(234m) 전망대', childNote: '해변에서 아이와 놀기 좋음' },
                        { time: '16:00', icon: '🧳', activity: '하카타역 이동 & 기념품', details: '마지막 기념품 쇼핑. 하카타 토오리몬, 멘타이코 추천', childNote: '' },
                        { time: '18:00', icon: '✈️', activity: '공항 출발', details: '지하철로 공항 이동 후 귀국', childNote: '' }
                    ]
                },
                {
                    day: 4, title: '귀국',
                    summary: '여유 있는 아침 후 공항에서 출발',
                    timeline: [
                        { time: '08:00', icon: '🍳', activity: '아침 식사', details: '호텔 조식 후 체크아웃', childNote: '' },
                        { time: '09:30', icon: '✈️', activity: '공항 이동', details: '하카타역에서 지하철로 공항 이동', childNote: '' },
                        { time: '10:00', icon: '🛒', activity: '공항 면세 쇼핑', details: '면세점에서 마지막 쇼핑', childNote: '' },
